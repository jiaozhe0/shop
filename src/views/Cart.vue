        ...
        <div class="item-list-wrap">
          <div class="cart-item">
            ...
            <ul class="cart-item-list">
              <li v-for="items in cartList">
                <div class="cart-tab-1">
                  <div class="cart-item-check">
                    <a href="javascipt:;" class="checkbox-btn item-check-btn" :class="{'check':items.checked == '1'}" @click="editCart('checked',items)">
                  ...
                  <div class="cart-item-pic">
                    <img :src="'/static/'+items.productImage">
                  </div>
                ...
                <div class="cart-tab-2">
                  <div class="item-price">{{items.salePrice}}</div>
                </div>
                <div class="cart-tab-3">
                  <div class="item-quantity">
                    <div class="select-self select-self-open">
                      <div class="select-self-area">
                        <a class="input-sub" @click="editCart('minu',items)">-</a>
                        <span class="select-ipt">{{items.productNum}}</span>
                        <a class="input-add" @click="editCart('add',items)">+</a>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="cart-tab-4">
                  <div class="item-price-total">{{(items.productNum * items.salePrice) | currency('$')}}</div>
                </div>
                <div class="cart-tab-5">
                  <div class="cart-item-opration">
                    <a href="javascript:;" class="item-edit-btn" @click="delCartConfirm(items.productId)">
